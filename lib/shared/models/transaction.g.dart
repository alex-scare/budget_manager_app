...
Transaction _transactionDeserialize(
  ...
  final object = Transaction(
    ...
    performedAt: reader.readDateTime(offsets[2]),
  );
  object.id = id;
  return object;
}
...
List<IsarLinkBase<dynamic>> _transactionGetLinks(Transaction object) {
  return [object.category, object.account, object.payee];
}
...
void _transactionAttach(
  ...
  object.payee.attach(col, col.isar.collection<Payee>(), r'payee', id);
}
...
extension TransactionQueryLinks
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> payee(
      FilterQuery<Payee> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'payee');
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> payeeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'payee', 0, true, 0, true);
    });
  }
}
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByPerformedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'performedAt', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByPerformedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByPerformedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'performedAt', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByPerformedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'performedAt', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByPerformedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, DateTime, QQueryOperations> performedAtProperty() {
    return QueryBuilder.apply(this, (query) {
